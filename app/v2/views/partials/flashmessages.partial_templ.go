...
func FlashMessages(errMsgs, sucMsgs []string) templ.Component {
	return templ.ComponentFunc(func(ctx context.Context, templ_7745c5c3_W io.Writer) (templ_7745c5c3_Err error) {
		...
		_, templ_7745c5c3_Err = templ_7745c5c3_Buffer.WriteString("<div _=\"init wait 5s then remove me\">")
		...
		if len(errMsgs) != 0 {
			...
			for _, msg := range errMsgs {
				...
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `app/v2/views/partials/flashmessages.partial.templ`, Line: 21, Col: 16}
				}
		...
		if len(sucMsgs) != 0 {
			...
			for _, msg := range sucMsgs {
				...
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `app/v2/views/partials/flashmessages.partial.templ`, Line: 43, Col: 16}
				}
